        ...
        <div className="fixed inset-0 z-[120] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              <div className="w-16 h-16 bg-danger/10 text-danger rounded-full flex items-center justify-center mb-6 shadow-sm border border-danger/20">
                <AlertCircle size={32} />
              </div>
              
              <h3 className="text-xl font-black text-text-main dark:text-white tracking-tight mb-2">
                {title}
              </h3>
              
              <p className="text-sm text-text-muted font-medium italic leading-relaxed mb-8 px-4">
                {message}
              </p>
